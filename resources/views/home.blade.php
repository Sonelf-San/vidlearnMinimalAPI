...
<div class="banner-content col-lg-9 col-md-12">
    <h1>ERICAE :</h1>
<h1 class="text">
Équipe de Recherche en Ingenierie des ConnAissancEs
</h1>
<p class="pt-10 pb-10" style = "color: rgb(240, 208, 5);">
Élaborer des méthodes, des modèles 
et des outils en ingénierie des connaissances
</p>
...
<div class="overlay overlay-bg"></div>
<img class="img-fluid" src="{{ asset('assets/img/images/p1.jpg') }}" alt="">
</div>
...
<div class="thumb relative">
<div class="overlay overlay-bg"></div>
<img class="img-fluid" src="{{ asset('assets/img/images/p2.jpg') }}" alt="">
</div>
<div class="meta d-flex justify-content-between">
<p><span class="lnr lnr-users"></span> 355 <span class="lnr lnr-bubble"></span>35</p>
<h4>$150</h4>
...
<div class="thumb relative">
<div class="overlay overlay-bg"></div>
<img class="img-fluid" src="{{ asset('assets/img/images/p3.jpg') }}" alt="">
</div>
<div class="meta d-flex justify-content-between">
<p><span class="lnr lnr-users"></span> 355 <span class="lnr lnr-bubble"></span>35</p>
<h4>$150</h4>
...
<div class="thumb relative">
<div class="overlay overlay-bg"></div>
<img class="img-fluid" src="{{ asset('assets/img/images/p4.jpg') }}" alt="">
</div>
<div class="meta d-flex justify-content-between">
<p><span class="lnr lnr-users"></span> 355 <span class="lnr lnr-bubble"></span>35</p>
<h4>$150</h4>
...
<img class="img-fluid" src="{{ asset('assets/img/images/e1.jpg') }}" alt="">
</div>
...
<div class="single-carusel row align-items-center">
<div class="col-12 col-md-6 thumb">
<img class="img-fluid" src="{{ asset('assets/img/images/e2.jpg') }}" alt="">
</div>
<div class="detials col-12 col-md-6">
<p>25th February, 2018</p>
<a href="#"><h4>The Universe Through
...
For most of us, the idea of astronomy is something we directly connect to “stargazing”, telescopes and seeing magnificent displays in the heavens.
    ...
    <div class="single-review item">
    <img src="{{ asset('assets/img/images/r1.png') }}" alt="">
    <div class="title justify-content-start d-flex">
    <a href="#"><h4>Fannie Rowe</h4></a>
    <div class="star">
    <span class="fa fa-star checked"></span>
    ...
    <section class="blog-area section-gap" id="blog">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="thumb">
                    <img class="img-fluid" src="{{ asset('assets/img/images/b1.jpg') }}" alt="">
                </div>
                ...
                <div class="col-lg-3 col-md-6 single-blog">
                    <div class="thumb">
                    <img class="img-fluid" src="{{ asset('assets/img/images/b2.jpg') }}" alt="">
                    </div>
                <p class="meta">25 April, 2018 | By <a href="#">Mark Wiens</a></p>
                <a href="blog-single.html">
                ...
                <div class="col-lg-3 col-md-6 single-blog">
                    <div class="thumb">
                        <img class="img-fluid" src="{{ asset('assets/img/images/b3.jpg') }}" alt="">
                    </div>
                <p class="meta">25 April, 2018 | By <a href="#">Mark Wiens</a></p>
                <a href="blog-single.html">
                ...
                <div class="col-lg-3 col-md-6 single-blog">
                    <div class="thumb">
                    <img class="img-fluid" src="{{ asset('assets/img/images/b4.jpg') }}" alt="">
                    </div>
                <p class="meta">25 April, 2018 | By <a href="#">Mark Wiens</a></p>
                <a href="blog-single.html">
