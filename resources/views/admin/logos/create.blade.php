            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.logos.index') }}">Logo</a></li>
                        <li class="breadcrumb-item active">Téléverser</li>
                    </ol>
                </div>
                <h4 class="page-title">Téléverser le logo</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
        ...
        <div class="card-body">
            <form method="POST" enctype="multipart/form-data"
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Logo Image <em>*</em></label>
                            <input type="file" accept="image/*" name="image"
                                class="form-control @error('image') is-invalid @enderror">
                                <input type="hidden" id="course_image"/>

                            <small class="d-block text-muted mt-1">Accepted format: .png, .jpg, .svg</small>

                            <img src="{{old('image')}}" style="width: 150px;" class="img-fluid mt-3"
                                id="preview" alt="">
                            @error('image')
