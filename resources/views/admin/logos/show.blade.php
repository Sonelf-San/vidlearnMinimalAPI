...
@section('content')
    ...
    <div class="row">
        <div class="col-md-4 mb-4">
            <div class="card">
                <div class="card-body">
                    <img src="{{ asset('storage/logos/' . $logo->image) }}" alt = "Image..." class="img-fluid mb-3">
                    <h3 class="text-capitalize mb-0">{{ $logo->name }}</h3>
                    <p class="mb-0"><span class="fa fa-stopwatch"></span> {{ $logo->created_at->diffForHumans() }}
                    </p>
                    <hr>
                            ...
                            <div class="modal-content">
                                ...
                                <form method="POST" action="{{ route('admin.logos.destroy', $logo->id) }}">
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                Are you sure you want to delete this activity ({{ $logo->name }}) ?
                                            </div>
                                        </div>
                                    </div>
