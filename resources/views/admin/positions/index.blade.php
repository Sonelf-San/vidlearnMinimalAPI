                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <button type="button" class="btn btn-danger btn-sm"
                                        data-toggle="modal"
                                        data-target="#deleteModal{{ $position->id }}"><span class="fa fa-trash"></span>
                                </button>
                            </div>
                        </td>
                    </tr>
                    ...
                    <div class="modal fade" id="deleteModal{{ $position->id }}" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <form method="POST" action="{{ route('admin.positions.destroy', $position->id) }}">
                                    @csrf
                                    <input type="hidden" name="_method" value="DELETE">
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                Are you sure you want to delete this Position ({{ $position->name }}) ?
                                            </div>
                                        </div>
                                    </div>
